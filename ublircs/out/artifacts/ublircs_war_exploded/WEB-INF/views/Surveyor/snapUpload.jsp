        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Inspected Snaps Gird</h4> </div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                  <%--  <button class="right-side-toggle waves-effect waves-light btn-info btn-circle pull-right m-l-20"><i class="ti-settings text-white"></i></button>--%>
                    <ol class="breadcrumb">
                        <li><a href="#">Branch User</a></li>
                        <li><a href="#">Snaps</a></li>
                        <li class="active">Snaps Upload Page</li>
                    </ol>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-0">Snaps Data Table</h3>
                        ...
                        <div class="table-responsive">
                            <table id="myTable" class="table table-striped">
                                ...
                                <c:forEach items="${locationInspectionPicsList}" var="img" varStatus="counter">
                                    <tr>
                                        <td><img src="<c:url value="/surveyor/getImage?id=${img.locInspId}"/>" style="width: 100px;height: 100px;" alt=""></td>
                                        <td style="vertical-align: middle" >${img.name}</td>
                                        <td style="vertical-align: middle">${img.description}</td>

                                        <td>
                                            <div class="btn-group-vertical row">
                                                <a title="Download" class="btn btn-block btn-success btn-rounded" href="<c:url value="/surveyor/inspectedPic/download/${img.raForm.raFormId}/${img.locInspId}" />"/><i class="mdi mdi-cloud-download"></i>Download</a>
                                                <br>
                                                <a title="Remove" class="btn btn-block btn-danger btn-rounded" href="<c:url value="/surveyor/inspectedPic/delete/${img.raForm.raFormId}/${img.locInspId}" />"/><i class="mdi mdi-delete-empty"></i>Remove</a>
                                            </div>
                                        </td>
                                    </tr>
            ...
            <form:form method="post" cssClass="form-horizontal" id="validation-form" enctype="multipart/form-data" modelAttribute="fileBucket" >
                    <div class="white-box">
                        <h3 class="box-title">Snap Upload</h3>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <form:input path="description" type="text" class="form-control" id="description" name="description" placeholder="Image description"/>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-lg-2 col-sm-4 col-xs-12 pull-right">
                                <button class="btn btn-block btn-outline btn-rounded btn-info"><i class="mdi mdi-cloud-upload"></i>&nbsp;Upload</button>
                            </div>
                        </div>
                    </div>
            </form:form>
                    <div class="row">
                        <div class="col-lg-2 col-sm-4 col-xs-12 pull-right">
                            <a href="<c:url value="../summary/${raForms.raFormId}"/>" class="btn btn-block btn-outline btn-rounded btn-info"><i class="mdi mdi-file-send"></i>To Summary</a>
                        </div>
                    </div>
                </div>
            </div>
