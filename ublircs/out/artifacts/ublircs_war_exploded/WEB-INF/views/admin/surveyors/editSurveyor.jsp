            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <form action="${pageContext.request.contextPath}/admin/surveyors/edit" method="post" commandName="surveyors" data-toggle="validator">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="form-group col-sm-6">
                                        ...
                                        <select path="userTypes.userTypeId" class="form-control" id="authority" required="required" data-placeholder="Select authority" name="authority" data-error="Select authority">
                                            <option value="" disabled selected>Choose authority...</option>
                                            <c:forEach items="${AllTypes}" var="authorityt">
                                                <option value="${authority.userTypeId}">${usert.usertype}</option>
                                            </c:forEach>
                                        </select>
                                        <div class="help-block with-errors"></div>
                                    </div>
