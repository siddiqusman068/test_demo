            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <form action="${pageContext.request.contextPath}/admin/users/edit" method="post" commandName="users" data-toggle="validator">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" path="name" name="userName" id="inputUserName" placeholder="User Name" data-error="Enter user name" required="required"/>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="form-group col-sm-6">
                                        ...
                                        <select path="userTypes.userTypeId" class="form-control" id="crole" required="required" data-placeholder="Select usertype" name="crole" data-error="Select user type">
                                    ...
                                    <div id="branch" class="form-group col-sm-6">
                                        ...
                                        <select path="branches.branchId" class="form-control"  id="brid" name="brid" required="required" data-placeholder="Select branch" data-error="Select branch">
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <div class="radio">
                                            <input path="status" type="radio" name="status" id="active" required="required" value="1" data-error="Select status">
                                            <label for="active"> Active </label>
                                        </div>
                                        <div class="radio">
                                            <input path="status" type="radio" name="status" id="inactive" required="required" value="0" data-error="Select status">
...
<script type="text/javascript">
    $(window).on('load',function(){
        var yes = document.getElementById('usertype').value;
