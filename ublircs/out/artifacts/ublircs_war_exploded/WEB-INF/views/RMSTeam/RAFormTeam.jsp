                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <form id="validation" class="form-horizontal" method="get"
                                  action="<c:url value="/rcsTeam/addTeamForm/getRMSTeamRAForm"/>">
                                <div class="row">
                                    <div class="col-sm-12">
                                                            ...
                                                            <div class="radio-list">
                                                                <label class="radio-inline p-0">
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="riskCost" id="below500m" value="Below 500 million">
                                                                        <label for="below500m">Below 500 million</label>
                                                                    </div>
                                                                </label>
                                                                <label class="radio-inline">
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="riskCost" id="above500m" value="Above 500 million">
                                                    ...
                                                    <h4 class="panel-title">
                                                        <a class="collapsed" data-toggle="collapse"
                                                           ...
                                                           aria-expanded="false" aria-controls="collapseTwo">
                                                            ...
                                                            <div class="below500mDetails" hidden style="display: inline">(Below 500m)</div>
                                                            <div class="above500mDetails" hidden style="display: inline;">(Above 500m)</div>
                                                        </a>
                                                    </h4></div>
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                ...
                                                                <c:url value="/rcsTeam/getCode" var="getRiskCode"/>
                                                                <input type="text" id="riskCode" name="riskCode" class="form-control" onfocusout="doAjax('${getRiskCode}',$(this).val())" placeholder="Risk Code">
                                                                <div id="reasonc" style="color: blue"></div>
                                                            </div>
                                                            <div class="col-md-4">
                                                        ...
                                                        <div hidden class="waiverDetails">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <div class="checkbox checkbox-info">
                                                                        <input type="checkbox" name="electricitySupply" id="notApplicabless" value="Not Applicable">
                                                                ...
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <div class="checkbox checkbox-info">
                                                                        <input type="checkbox" name="sourcesOfWaterSupply" id="notApplicablees" value="Not Applicable">
...
<!-- /#wrapper -->
<%@ include file="/WEB-INF/views/template/footerRMSTeam.jsp" %>
...
<script type="text/javascript">
    function doAjax(lookUrl,riskCode) {
        //alert(cnicNtn);
        $.ajax({
            url: lookUrl,
