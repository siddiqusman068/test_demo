        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="text-right">
                    <a href="/ublircs/rcsTeam/users/add" class="fcbtn btn btn-info btn-outline btn-1d m-r-10">Create User</a>
                </div>
            </div>
            <br>
            <!-- /row -->
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-0">Users Data Table</h3>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-toolbar">
                                                <c:if test="${user.userTypes.userTypeId == '3' || user.userTypes.userTypeId == '4'}">
                                                    <a href="<spring:url value="/rcsTeam/users/edit/${user.userId}"/>"
                                                       TITLE="Edit user" class="btn btn-default btn-circle btn-lg"><i
                                                            class="mdi mdi-account-edit"></i> </a>
                                                    <a href="<spring:url value="/rcsTeam/users/reset/${user.userId}"/>"
                                                       TITLE="Reset user password"
                                                       class="btn btn-primary btn-circle btn-lg"><i
                                                            class="mdi mdi-account-key"></i> </a>
                                                </c:if>
                                                <c:if test="${user.userTypes.userTypeId == '2'}">
                                                    <a href="<spring:url value="/rcsTeam/users/reset/${user.userId}"/>"
                                                       TITLE="Reset user password"
                                                       class="btn btn-primary btn-circle btn-lg"><i
                                                            class="mdi mdi-account-key"></i> </a>
