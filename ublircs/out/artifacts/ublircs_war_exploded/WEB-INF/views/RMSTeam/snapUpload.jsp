                        ...
                        <div class="table-responsive">
                            <table id="myTable" class="table table-striped">
                                ...
                                <c:forEach items="${locationInspectionPicsList}" var="img" varStatus="counter">
                                    <tr>
                                        <td><img src="<c:url value="/rcsTeam/getImage?id=${img.locInspId}"/>" style="width: 100px;height: 100px;" alt=""></td>
                                        ...
                                        <td>
                                            <div class="btn-group-vertical row">
                                                <a title="Download" class="btn btn-block btn-success btn-rounded" href="<c:url value="/rcsTeam/inspectedPic/download/${img.raForm.raFormId}/${img.locInspId}" />"/><i class="mdi mdi-cloud-download"></i>Download</a>
                                                <br>
                                                <a title="Remove" class="btn btn-block btn-danger btn-rounded" href="<c:url value="/rcsTeam/inspectedPic/delete/${img.raForm.raFormId}/${img.locInspId}" />"/><i class="mdi mdi-delete-empty"></i>Remove</a>
                                            </div>
