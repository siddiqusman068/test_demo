            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <form:form action="${pageContext.request.contextPath}/rcsTeam/branches/edit" method="post" commandName="branches" data-toggle="validator">
                            <form:hidden path="branchId" value="${branches.branchId}" />
                            <input type="hidden" id="currentBranchCode" value="${branches.branchCode}" name="currentBranchCode" style="color: #0b0b0b">
                            <input type="hidden" id="afterBranchCode" value="" name="afterBranchCode" style="color: #0b0b0b">
                            <input type="hidden" id="currentLocationCode" value="${branches.locationCode}" name="currentLocationCode" style="color: #0b0b0b">
                            <input type="hidden" id="afterLocationCode" value="" name="afterLocationCode" style="color: #0b0b0b">
                            <input type="hidden" id="currentBranchName" value="${branches.branchName}" name="currentBranchName" style="color: #0b0b0b">
                            <input type="hidden" id="afterBranchName" value="" name="afterBranchName" style="color: #0b0b0b">
...
<script type="text/javascript">
    ...
    $('#branchCode').change(function () {
        $('#afterBranchCode').val($(this).val());
    });

    $('#locationCode').change(function () {
        $('#afterLocationCode').val($(this).val());
    });

    $('#branchName').change(function () {
        $('#afterBranchName').val($(this).val());
    });
