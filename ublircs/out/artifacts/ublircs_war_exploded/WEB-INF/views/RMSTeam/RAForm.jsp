...
<script type="text/javascript">
    $(window).on('load', function () {
        $("input:radio[name='cctvCameras']").click(function() {

            var cctv = $("input[name=cctvCameras]:checked").val();

            if ($("#readRiskCosting").val() == 'Above 500 million' && cctv == "Yes") {
                $("#cameras").show();
                alert($("#readRiskCosting").val())
            ...
            } else if ($("#readRiskCosting").val() == 'Above 500 million' && cctv == "No") {
                $("#cameras").hide();
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <form id="validation" class="form-horizontal" method="get"
                  action="<c:url value="/rcsTeam/addForm/getRMTeamRAForm"/>">
                <div class="row">
                    <div class="col-sm-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <input type="text" id="readRiskCosting" value="${raForms.riskCost}"/>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="checkbox checkbox-info">
                                                    <input type="checkbox" name="sourcesOfWaterSupply" id="notApplicableee" value="Not Applicable">
                                                    <label for="notApplicableee"> N/A </label>
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
