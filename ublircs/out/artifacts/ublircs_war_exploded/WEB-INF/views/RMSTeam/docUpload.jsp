                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group-vertical row">
                                                ...
                                                <br>
                                                <a title="Remove" class="btn btn-block btn-danger btn-rounded" href="<c:url value="/rcsTeam/delete/${doc.raForm.raFormId}/${doc.locReportId}" />"/><i class="mdi mdi-delete-empty"></i>Remove</a>
                                            </div>
