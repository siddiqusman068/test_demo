        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Risk Register</h4></div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <%--<button class="right-side-toggle waves-effect waves-light btn-info btn-circle pull-right m-l-20"><i class="ti-settings text-white"></i></button>--%>
                    <ol class="breadcrumb">
                        <li><a href="#">RMD Team</a></li>
            ...
            <div class="row">
                <div class="text-right">
                    <a href="<c:url value="/rcsTeam/addTeamForm"/>" class="fcbtn btn btn-info btn-outline btn-1d m-r-10">Initiate
                        risk</a>
                </div>
            </div>
            <br>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <table id="RMSTeamGrid" class="table table-striped">
                            <thead>
                            <tr>
                            ...
                            <c:forEach items="${raFormsList}" var="ra" varStatus="counter">
                                <tr>
                                    ...
                                    <td style="vertical-align: middle">
                                        ...
                                        <c:if test="${ra.ranks.equals('Light Green #9BCD5Cn')}">
                                    ...
                                    <td style="vertical-align: middle">
                                        <c:if test="${ra.status.equals('Assigned For Inspection')}">
                                            <a class="btn btn-block btn-warnig btn-rounded" href="<spring:url value="/rcsTeam/addForm/${ra.raFormId}"/>">Assigned For Inspection</a>
                                        </c:if>
                                        ...
                                        <c:if test="${ra.status.equals('Request For Waive')}">
                                            <a class="btn btn-block btn-success btn-rounded">Waiting For Waiver Approval</a><br>
                                        </c:if>
                                    </td>
                                    <td style="vertical-align: middle">
                                        <c:if test="${ra.status.equals('Inspection In Progress') || ra.status.equals('Waived') || ra.status.equals('Waiting for Evaluation')}">
                                            <button style="display: inline-block" class="btn btn-primary btn-circle btn-lg" title="Edit RAF" onclick="location.href='http://localhost:8080/ublircs/rcsTeam/editForm/${ra.raFormId}'"><i class="fa fa-edit"></i></button>
                                        </c:if>
                                        <c:if test="${ra.status.equals('Evaluation Complete') || ra.status.equals('Waived')}">
                                            <button style="display: inline-block" class="btn btn-primary btn-circle btn-lg" title="Re-Inspection" onclick="location.href='http://localhost:8080/ublircs/rcsTeam/reInspectionRisk/${ra.raFormId}'"><i class="fa fa-search"></i></button>
                                            <button style="display: inline-block" class="btn btn-primary btn-circle btn-lg" title="Summary" onclick="location.href='http://localhost:8080/ublircs/rcsTeam/briefSummary/${ra.raFormId}'"><i class="fa  fa-files-o"></i></button>
                                        </c:if>
                                    </td>
                                </tr>
                            </c:forEach>
