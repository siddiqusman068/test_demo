        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Assigned Risk Register</h4> </div>
...
<%--            <div class="row">
                <div class="text-right">
                    <a href="<c:url value="/rcsTeam/addForm"/>" class="fcbtn btn btn-info btn-outline btn-1d m-r-10">Initiate risk</a>
                </div>
            </div>--%>
            <br>
            <!-- /row -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <c:if test="${ra.status.equals('Assigned For Inspection')}">
                                                <a href="<spring:url value="/rcsTeam/addForm/${ra.raFormId}"/>" class="btn btn-block btn-warning btn-rounded">Assigned For Inspection</a>
                                            </c:if>
                                            ...
                                            <c:if test="${ra.status.equals('Evaluation Complete')}">
                                                ...
                                                <a  href="<spring:url value="/rcsTeam/reInspection/${ra.raFormId}"/>" class="btn btn-block btn-info btn-rounded">ReInspection </a>
                                            </c:if>
                                        </td>
                                            <%--  <td>
                                                 &lt;%&ndash; <div class="btn-group">
                                                      <a class="btn waves-effect waves-light right submit indigo darken-3" title="Edit User" href="<spring:url value="users/evaluate/${ra.raFormId}"/>"> Evaluate Risk</a>
                                                  </div>&ndash;%&gt;
                                              </td>--%>
                                    </tr>
                                </c:forEach>
