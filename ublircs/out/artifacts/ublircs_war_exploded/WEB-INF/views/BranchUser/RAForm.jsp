...
<%@ include file="/WEB-INF/views/template/headerBranchUser.jsp" %>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <!-- .row -->
                        <form id="validation" class="form-horizontal" method="get" action="<c:url value="/branchUser/addForm/getbranchUserRAForm"/>">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="panel-group wiz-aco" id="accordion" role="tablist"
                                                ...
                                                <h4 class="panel-title">
                                                    <a data-toggle="collapse" data-parent="#accordion"
                                                       ...
                                                       aria-controls="collapseOne">
                                                        <i style="font-size: 20px" class="fa fa-bitcoin"></i><span>&nbsp;Risk Cost</span>
                                                    </a>
                                                </h4></div>
                                                    ...
                                                    <div class="radio-list">
                                                        <label class="radio-inline p-0">
                                                            <div class="radio radio-info">
                                                                <input type="radio" name="riskCost" id="below500m"
                                                                       value="Below 500 million">
                                                                <label for="below500m">Below 500 million</label>
                                                            </div>
                                                        </label>
                                                        <label class="radio-inline">
                                                            <div class="radio radio-info">
                                                                <input type="radio" name="riskCost" id="above500m"
                                                                       value="Above 500 million">
                                                                <label for="above500m">Above 500 million</label>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel"
                                                ...
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" id="riskCode" name="riskCode" class="form-control"
                                                                   placeholder="Risk Code">
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label class="control-label">City</label>
                                                            <select path="industries" id="city" name="city" class="form-control"
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" id="policyNo" name="policyNo" class="form-control"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" id="visitDate" name="visitDate"
                                                ...
                                                <textarea id="riskLocation" name="riskLocation"
                                                          placeholder="Risk location" class="form-control"></textarea>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label for="headOfficeAddress" class="control-label">Head Office
                                                                Address</label>
                                                <textarea id="headOfficeAddress" name="headOfficeAddress"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" class="form-control" id="natureOfBusinessOccupation"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" id="lossHistoryAmount"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="checkbox checkbox-info">
                                                                <input type="checkbox" name="subjectMatter" id="machinery"
                                                                       value="Machinery">
                                                            ...
                                                            <div class="checkbox checkbox-info">
                                                                <input type="checkbox" name="subjectMatter" id="building"
                                                                       value="Building">
                                                                <label for="building"> Building </label>
                                                            </div>
                                                            <div class="checkbox checkbox-info">
                                                                <input type="checkbox" name="subjectMatter" id="generator"
                                                                       value="Generator">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <%--<div class="col-md-6">
                                                            <label class="control-label">Sum Isured</label>
                                                            <input type="text" class="form-control" id="sumInsured" name="sumInsured" placeholder="Sum Insured">
                                                        </div>--%>
                                                    </div>
                                                    <div hidden class="waiverDetails">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <label class="control-label">Is the premises owned or
                                                                    rented?</label>
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="premisesOwnedRented" id="owned"
                                                                           value="Owned">
                                                                    <label for="owned"> Owned </label>
                                                                </div>
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="premisesOwnedRented" id="rented"
                                                                           value="Rented">
                                                                    <label for="rented"> Rented </label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label class="control-label">Does the premises has multiple
                                                                    tenancy?</label>
                                                                <div class="radio radio-info">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="premisesSurrounding" id="front"
                                                                           value="Front">
                                                        ...
                                                        <textarea class="form-control" id="frontDetails"
                                                                ...
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="premisesSurrounding" id="back"
                                                                           value="Back">
                                                        ...
                                                        <textarea class="form-control" id="backDetails"
                                                                ...
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="premisesSurrounding" id="left"
                                                                           value="Left">
                                                        ...
                                                        <textarea class="form-control" id="leftDetails"
                                                                ...
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="premisesSurrounding" id="right"
                                                                           value="Right">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input type="text" class="form-control" id="noOfFloors"
                                                                           name="noOfFloors" placeholder="No. of floors">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="plinthLevel" id="roadLevel"
                                                                           value="Road Level">
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="floorCondition" id="satisfactory"
                                                                           value="Satisfactory">
                                                                    <label for="satisfactory"> Satisfactory </label>
                                                                </div>
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="floorCondition" id="improvements"
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="electricWiring" id="conduit"
                                                                           value="Conduit">
                                                                    <label for="conduit"> Conduit </label>
                                                                </div>
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="electricWiring" id="concealed"
                                                                           value="Concealed">
                                                                    <label for="concealed"> Concealed </label>
                                                                </div>
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="electricWiring" id="open"
                                                                           value="Open">
                                                                    <label for="open"> Open </label>
                                                                </div>
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="electricWiring" id="loose"
                                                                           value="Loose in some areas">
                                                                    <label for="loose"> Loose in some areas </label>
                                                                </div>
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="electricWiring" id="needImprove"
                                                                           value="Needs Improvement">
                                                                    <label for="needImprove"> Needs Improvement </label>
                                                                </div>
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="electricWiring" id="notApplicablee"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="houseKeeping" id="satisfy"
                                                                           value="Satisfactory">
                                                                ...
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="houseKeeping" id="notApplicables"
                                                                           value="Not Applicable">
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="cigaretteSmoking" id="smoke"
                                                                           value="Smoking">
                                                                    <label for="smoke"> Smoking </label>
                                                                </div>
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="cigaretteSmoking" id="nonSmoke"
                                                                           value="Non-Smoking">
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="storageArrangements"
                                                                           id="arrangesatisfactory" value="Satisfactory">
                                                                    <label for="arrangesatisfactory"> Satisfactory </label>
                                                                </div>
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="storageArrangements"
                                                                           id="arrangeimprovements" value="Need Improvement">
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="rawMaterialStored" id="godown"
                                                                           value="Separate Godown">
                                                                    <label for="godown"> Separate Godown </label>
                                                                </div>
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="rawMaterialStored" id="processArea"
                                                                           value="Process Area">
                                                                    <label for="processArea"> Process Area </label>
                                                                </div>
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="rawMaterialStored" id="openStorage"
                                                                           value="Open">
                                                                    <label for="openStorage"> Open </label>
                                                                </div>
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="rawMaterialStored"
                                                                           id="notApplicabless" value="Not Applicable">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="storedIn" id="storedgodown"
                                                                           value="Separate Godown">
                                                                    <label for="storedgodown"> Separate Godown </label>
                                                                </div>
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="storedIn" id="storedprocessArea"
                                                                           value="Process Area">
                                                                    <label for="storedprocessArea"> Process Area </label>
                                                                </div>
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="storedIn" id="storedopenStorage"
                                                                           value="Open">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="typeCylinders" id="typeYes"
                                                                           value="Yes">
                                                                ...
                                                                <div style="display:none " id="typeofCylinders">
                                                                    <input type="text" class="form-control" id="noofCylinders"
                                                                           name="noofCylinders" placeholder="No. of cylinders">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <label class="control-label">Is hazardous material stored
                                                                    separately?</label>
                                                                <div class="radio radio-info">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="nightWork" id="nightWorkYes"
                                                                           value="Yes">
                                                                    <label for="nightWorkYes"> Yes </label>
                                                                </div>
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="nightWork" id="nightWorkNo"
                                                                           value="No">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="warehousesElectrified" id="electricNo"
                                                                           value="No">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="securityArrangement"
                                                                           id="securitySatisfactory" value="Satisfactory">
                                                                    <label for="securitySatisfactory"> Satisfactory </label>
                                                                </div>
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="securityArrangement"
                                                                           id="securityImprove" value="Needs Improvement">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div style="display:none " id="cameras">
                                                                    <input type="text" class="form-control" id="noofcctvCameras"
                                                                           name="noofcctvCameras" placeholder="No. of CCTV cameras">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="fireFightingTeam" id="fireTeamYes"
                                                                           value="Yes">
                                                                    <label for="fireTeamYes"> Yes </label>
                                                                </div>
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="fireFightingTeam" id="fireTeamNo"
                                                                           value="No">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <input type="text" class="form-control" id="frequencyOfDrill"
                                                                       name="frequencyOfDrill" placeholder="Drill frequency">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label class="control-label">Fire Exits Provided?</label>
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="fireExitsProvided" id="fireExitsYes"
                                                                           value="Yes">
                                                                    <label for="fireExitsYes"> Yes </label>
                                                                </div>
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="fireExitsProvided" id="fireExitsNo"
                                                                           value="No">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <label class="control-label">No. Of Fire Extinguishers
                                                                    Installed</label>
                                                                <input type="text" class="form-control" id="noOfFireExtinguishers"
                                                            ...
                                                            <div class="col-md-6">
                                                                <label class="control-label">No. Of Fire Buckets
                                                                    (Water/Sand)</label>
                                                                <input type="text" class="form-control" id="noOfFireBuckets"
                                                                       name="noOfFireBuckets" placeholder="No. Of Fire Buckets">
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="hydrantSystem" id="hydrantSystemYes"
                                                                           value="Yes">
                                                                    <label for="hydrantSystemYes"> Yes </label>
                                                                </div>
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="hydrantSystem" id="hydrantSystemNo"
                                                                           value="No">
                                                                    <label for="hydrantSystemNo"> No </label>
                                                                </div>
                                                                <div style="display:none " id="hydrantSystem">
                                                                    <hr>
                                                                    <input type="text" class="form-control" id="noofHydrantPoints"
                                                                           name="noofHydrantPoints"
                                                                           placeholder="No. of hydrant points">
                                                                    <hr>
                                                                    <input type="text" class="form-control" id="noofFireHoses"
                                                                           name="noofFireHoses" placeholder="No. of fire hoses">
                                                                    <hr>
                                                                    <input type="text" class="form-control" id="hydrantpumpCapacity"
                                                                           name="hydrantpumpCapacity"
                                                                           placeholder="Hydrant pump capacity">
                                                                    <hr>
                                                                    <input type="text" class="form-control" id="hydrantPressure"
                                                                           name="hydrantPressure" placeholder="Hydrant pressure">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label class="control-label">Hydrant pump stiil operates after
                                                                    electricity shuts?</label>
                                                                <div class="radio radio-info">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="electricitySupply"
                                                                           id="publicSupply" value="Public Electric Supply">
                                                                    <label for="publicSupply"> Public Electric Supply </label>
                                                                </div>
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="electricitySupply" id="inHouse"
                                                                           value="In House">
                                                                    <label for="inHouse"> In House </label>
                                                                </div>
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="electricitySupply" id="powerHouse"
                                                                           value="Power House">
                                                                    <label for="powerHouse"> Power House </label>
                                                                </div>
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="electricitySupply" id="generators"
                                                                           value="Generators">
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                       name="capacityUndergroundTank" id="capacityUndergroundTank"
                                                                       placeholder="Underground tank capacity">
                                                            </div>
                                                            <div class="col-md-3">
                                                                <label class="control-label">Capacity Of Overhead Tank(s)</label>
                                                                <input type="text" class="form-control" name="capacityOverheadTank"
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="sourcesOfWaterSupply" id="tubeWell"
                                                                           value="Tube Well">
                                                                    <label for="tubeWell"> Tube Well </label>
                                                                </div>
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="sourcesOfWaterSupply" id="tankers"
                                                                           value="Tankers">
                                                                    <label for="tankers"> Tankers </label>
                                                                </div>
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="sourcesOfWaterSupply" id="bore"
                                                                           value="Bore">
                                                                    <label for="bore"> Bore </label>
                                                                </div>
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="sourcesOfWaterSupply"
                                                                           id="notApplicablees" value="Not Applicable">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="fireAlarmInstalled" id="fireAlarmYes"
                                                                           value="Yes">
                                                                    <label for="fireAlarmYes"> Yes </label>
                                                                </div>
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="fireAlarmInstalled" id="fireAlarmNo"
                                                                           value="No">
                                                    ...
                                                    <textarea id="nearestHospital" name="nearestHospital"
                                                            ...
                                                            <div class="col-md-6">
                                                                <label for="responseTimeHospital" class="control-label">Response
                                                                    Time (Hospital)</label>
                                                                <input id="responseTimeHospital" name="responseTimeHospital"
                                                    ...
                                                    <textarea id="nearestPoliceStation" name="nearestPoliceStation"
                                                              placeholder="Nearer police station"
                                                              class="form-control"></textarea>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label for="responseTimePoliceStation" class="control-label">Response
                                                                    Time (Police Station)</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <label for="nearestFireStation" class="control-label">Nearest Fire
                                                                    Station</label>
                                                    <textarea id="nearestFireStation" name="nearestFireStation"
                                                              placeholder="Nearer fire station"
                                                              class="form-control"></textarea>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label for="responseTimeFireStation" class="control-label">Response
                                                                    Time (Fire Station)</label>
                                                                <input id="responseTimeFireStation" name="responseTimeFireStation"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <label class="control-label">Accessibility For Fire
                                                                    Fighters?</label>
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="accessibilityForFireFighters"
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div hidden id="boilerDetails">
                                                                    <hr>
                                                                    <input type="text" class="form-control"
                                                                           id="boilerInstalledInUse" name="boilerInstalledInUse"
                                                                           placeholder="Boiler installed or in use">
                                                                    <hr>
                                                                    <input type="text" class="form-control" id="boilerMake"
                                                                           name="boilerMake" placeholder="Boiler make">
                                                                    <hr>
                                                                    <input type="text" class="form-control" id="boilerType"
                                                                           name="boilerType" placeholder="Boiler type">
                                                                    <hr>
                                                                    <label class="control-label">Boiler Is Heated By?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="boilerHeatedBy" id="gas"
                                                                               value="Gas">
                                                                        <label for="gas"> Gas </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="boilerHeatedBy" id="electricity"
                                                                               value="Electricity">
                                                                        <label for="electricity"> Electricity </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="boilerHeatedBy" id="oil"
                                                                               value="Oil">
                                                                        <label for="oil"> Oil </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="boilerHeatedBy" id="biofuel"
                                                                               value="Bio Fuel">
                                                                        <label for="biofuel"> Bio Fuel </label>
                                                                    </div>
                                                                    <hr>
                                                                    <label class="control-label">Boiler Fitness Certificate
                                                                        Shown/Provided?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="boilerFitnessCertificate"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <div hidden id="generatorDetails">
                                                                    ...
                                                                    <hr>
                                                                    <input type="text" class="form-control" id="generatorMake"
                                                                           name="generatorMake" placeholder="Generator make">
                                                                    <hr>
                                                                    <input type="text" class="form-control" id="generatorCapacity"
                                                                           name="generatorCapacity"
                                                                           placeholder="Generator Capacity">
                                                                    <hr>
                                                                    <input type="text" class="form-control" id="generatorKVA"
                                                                           name="generatorKVA" placeholder="Generator KVA">
                                                                    <hr>
                                                                    <label class="control-label">Generator Fuel Type?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="generaorFuel" id="diesel"
                                                                               value="Diesel">
                                                                        <label for="diesel"> Diesel </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="generaorFuel" id="petrol"
                                                                               value="Petrol">
                                                                        <label for="petrol"> Petrol </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="generaorFuel" id="generaorgas"
                                                                               value="Gas">
                                                                        <label for="generaorgas"> Gas </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="generaorFuel" id="kerosene"
                                                                               value="Kerosene">
                                                                    ...
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="generatorInterconnected"
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div hidden id="transformerDetails">
                                                                    <hr>
                                                                    <input type="text" class="form-control" id="transformerMake"
                                                                           name="transformerMake" placeholder="Transformer make">
                                                                    <hr>
                                                                    <input type="text" class="form-control" id="transformerCapacity"
                                                                           name="transformerCapacity"
                                                                           placeholder="Transformer Capacity">
                                                                    <hr>
                                                                    <input type="text" class="form-control" id="transformerKVA"
                                                                           name="transformerKVA" placeholder="Transformer KVA">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="leakagesFound" id="leakagesFoundYes"
                                                                           value="Yes">
                                                                    <label for="leakagesFoundYes"> Yes </label>
                                                                </div>
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="leakagesFound" id="leakagesFoundNo"
                                                                           value="No">
                                                                ...
                                                                <div hidden id="leakagesDetails">
                                                                    <hr>
                                                                    <input type="text" class="form-control"
                                                                           id="leakagesFoundDetails" name="leakagesFoundDetails"
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="machineryCondition"
                                                                           id="machineryConditionSatisfactory" value="Satisfactory">
                                                                    <label for="machineryConditionSatisfactory">
                                                                        Satisfactory </label>
                                                                </div>
                                                                <div class="radio radio-info">
                                                                    <input type="radio" name="machineryCondition"
                                                                           id="machineryConditionImprove" value="Needs Improvement">
                                                                    <label for="machineryConditionImprove"> Needs
                                                                        Improvement </label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label class="control-label">Is Maintenance Carried Out
                                                                    Regularly?</label>
                                                                <div class="radio radio-info">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <input type="text" class="form-control" id=noOfFireFighters
                                                                       name="noOfFireFighters"
                                                ...
                                                <h4 class="panel-title">
                                                    <a class="collapsed" data-toggle="collapse" data-parent="#accordion"
                                                       ...
                                                       aria-controls="collapseThree">
                                                        <i style="font-size: 20px" class="fa fa-building-o"></i></span>
                                                        &nbsp;Risk Specific
                                                        <div class="below500mDetails" hidden style="display: inline;">
                                                            Appoint
                                                            Surveyor/RMS Team
                                                ...
                                                <div class="panel-body">
                                                    <div class="below500mDetails">
                                                        ...
                                                        <div id="textileGarmentFactory">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Separate godowns are provided for
                                                                        raw material & finished goods with perfect partitioning
                                                                        walls?</label>
                                                                    <div class="radio radio-info">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Double sliding fireproof doors are
                                                                        ...
                                                                        hall?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="fireproofdoorsInstalled"
                                                                               id="fireproofdoorsInstalledYes" value="Yes">
                                                                        <label for="fireproofdoorsInstalledYes"> Yes </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="fireproofdoorsInstalled"
                                                                               id="fireproofdoorsInstalledNo" value="No">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Raw cotton in open (if any) is
                                                                        stored at least 30 feet away from any building?</label>
                                                                    <div class="radio radio-info">
                                                                    ...
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="stored30feetaway"
                                                                               id="stored30feetawayNA" value="Not Available">
                                                                        <label for="stored30feetawayNA"> Not Available </label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label class="control-label">No stock is stored inside the
                                                                        production area more than day's requirement?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="storedstockproductionarea"
                                                                               id="storedstockproductionareaYes" value="Yes">
                                                                        <label for="storedstockproductionareaYes"> Yes </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="storedstockproductionarea"
                                                                               id="storedstockproductionareaNo" value="No">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Godowns/warehouses are
                                                                        electrified?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="godownswarehouseselectrified"
                                                                               id="godownswarehouseselectrifiedYes" value="Yes">
                                                                        <label for="godownswarehouseselectrifiedYes"> Yes </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="godownswarehouseselectrified"
                                                                               id="godownswarehouseselectrifiedNo" value="No">
                                                                        <label for="godownswarehouseselectrifiedNo"> No </label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Separate blow rooms for cotton and
                                                                        or polyester are provided?</label>
                                                                    <div class="radio radio-info">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Proper cotton dust collection
                                                                        system is operated?</label>
                                                                    <div class="radio radio-info">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <label class="control-label">No fire-wood/diesel or any fuel is
                                                                        stored within 50 feet of any building or stock?</label>
                                                                    <div class="radio radio-info">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Installed spinning mill
                                                                        capacity</label>
                                                                    <input type="text" class="form-control"
                                                                           id="installedspinningmills" name="installedspinningmills"
                                                        ...
                                                        <div id="cottonGinningPressingFactory">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Phutti or loose cotton is stacked
                                                                        50 feet away from any building?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="phutticottonstack50feetstored"
                                                                               id="phutticottonstack50feetstoredYes" value="Yes">
                                                                        <label for="phutticottonstack50feetstoredYes"> Yes </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="phutticottonstack50feetstored"
                                                                               id="phutticottonstack50feetstoredNo" value="No">
                                                                        <label for="phutticottonstack50feetstoredNo"> No </label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label class="control-label">No stock of loose cotton/phutti is
                                                                        stacked inside process area?</label>
                                                                    <div class="radio radio-info">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="control-label">No ore than 2500 FPIB cotton bales
                                                                        are stored in any one godown?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="2500FPIBcottonbalesstrored"
                                                                               id="2500FPIBcottonbalesstroredYes" value="Yes">
                                                                        <label for="2500FPIBcottonbalesstroredYes"> Yes </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="2500FPIBcottonbalesstrored"
                                                                               id="2500FPIBcottonbalesstroredNo" value="No">
                                                                        <label for="2500FPIBcottonbalesstroredNo"> No </label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label class="control-label">No ore than 1000 FPIB cotton bales
                                                                        are stored in any one stack?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="1000FPIBcottonbalesstored"
                                                                               id="1000FPIBcottonbalesstoredYes" value="Yes">
                                                                        <label for="1000FPIBcottonbalesstoredYes"> Yes </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="1000FPIBcottonbalesstored"
                                                                               id="1000FPIBcottonbalesstoredNo" value="No">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Maximum height of each stack does
                                                                        not exceed 6 bales?</label>
                                                                    <div class="radio radio-info">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Distance between the lots of bales
                                                                        is approximately 75 feet?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="lotsofbaledistance75feet"
                                                                               id="lotsofbaledistance75feetYes" value="Yes">
                                                                        <label for="lotsofbaledistance75feetYes"> Yes </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="lotsofbaledistance75feet"
                                                                               id="lotsofbaledistance75feetNo" value="No">
                                                                        <label for="lotsofbaledistance75feetNo"> No </label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Cotton bales are stacked 30 feet
                                                                        away from any building?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="cottonbalesdistance30feet"
                                                                               id="cottonbalesdistance30feetYes" value="Yes">
                                                                        <label for="cottonbalesdistance30feetYes"> Yes </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="cottonbalesdistance30feet"
                                                                               id="cottonbalesdistance30feetNo" value="No">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Not more than 10,000 FPIB cotton
                                                                        bales are stored in open at single location?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="10000FPIBcottonbalesstored"
                                                                               id="10000FPIBcottonbalesstoredYes" value="Yes">
                                                                        <label for="10000FPIBcottonbalesstoredYes"> Yes </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="10000FPIBcottonbalesstored"
                                                                               id="10000FPIBcottonbalesstoredNo" value="No">
                                                        ...
                                                        <div id="oilfeedMills">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Is the risk of spontaneous
                                                                        combustion covered ?</label>
                                                                    <div class="radio radio-info">
                                                                    ...
                                                                    <div hidden id="combustioncovereddetails">
                                                                        <div class="col-md-6">
                                                                            <label class="control-label">Perentange of sum
                                                                                insured</label>
                                                                            <input type="text" id="combustionsuminsuredpercent"
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input type="text" id="noofsilosatfactory"
                                                                           name="noofsilosatfactory" class="form-control"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Is the stock of seed stored in open
                                                                        ?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="seedstored" id="seedstoredYes"
                                                                               value="Yes">
                                                                        <label for="seedstoredYes"> Yes </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="seedstored" id="seedstoredNo"
                                                                               value="No">
                                                                        <label for="seedstoredNo"> No </label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Distance between the walls of the
                                                                        godown and stocks is 4 feet?</label>
                                                                    <div class="radio radio-info">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Fire lanes are marked inside the
                                                                        godowns(12 ft between the society)?</label>
                                                                    <div class="radio radio-info">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Maximum heigth of each stack does
                                                                        not exceed 15 ft?</label>
                                                                    <div class="radio radio-info">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Not more than 8,000 bags are spaced
                                                                        in each stack?</label>
                                                                    <div class="radio radio-info">
                                                        ...
                                                        <div id="cosmeticsChemicalFactoriesLabs">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Tick the hazardous chemiclas stored
                                                                        at the facility from the following list?</label>
                                                                    <div class="checkbox checkbox-info">
                                                                        <input type="checkbox" name="hazardouschemicalstored"
                                                                    ...
                                                                    <div class="checkbox checkbox-info">
                                                                        <input type="checkbox" name="hazardouschemicalstored"
                                                                               id="propyleneglycol" value="Propylene Glycol">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Chemicals are stored in separate
                                                                        air conditioned godowns?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="chemicalseparatestored"
                                                                               id="chemicalseparatestoredYes" value="Yes">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Chemicals storage is 30 feet away
                                                                        from porduction area?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="chemicalseparatestored30feet"
                                                                               id="chemicalseparatestored30feetYes" value="Yes">
                                                                        <label for="chemicalseparatestored30feetYes"> Yes </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="chemicalseparatestored30feet"
                                                                               id="chemicalseparatestored30feetNo" value="No">
                                                                        <label for="chemicalseparatestored30feetNo"> No </label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Quantity of raw material placed in
                                                                        production hall?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="rawmaterialquantity" id="nil"
                                                                               value="Nil">
                                                                        <label for="nil"> Nil </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="rawmaterialquantity" id="oneday"
                                                                               value="Enough for one day">
                                                                        <label for="oneday"> Enough for one day </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="rawmaterialquantity" id="oneweek"
                                                                               value="Enough for one week">
                                                                    ...
                                                                    <div class="radio radio-info">
                                                                        ...
                                                                        <label for="moreoneweek"> Enough for more than one
                                                                            week </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <label class="control-label">Dry water mist & powder type fire
                                                                        extinguishers are provided to combat A,B,C & D type
                                                                        fires?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="fireextinguishersprovided"
                                                                               id="fireextinguishersprovidedYes" value="Yes">
                                                                        <label for="fireextinguishersprovidedYes"> Yes </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="fireextinguishersprovided"
                                                                               id="fireextinguishersprovidedNo" value="No">
                                                        ...
                                                        <div id="livestockfarms">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="control-label">How frequently the animals are
                                                                        vaccinated?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="animalsvaccinated" id="monthly"
                                                                               value="Monthly">
                                                                        <label for="monthly"> Monthly </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="animalsvaccinated" id="quarterly"
                                                                               value="Quarterly">
                                                                    ...
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="animalsvaccinated" id="annually"
                                                                               value="Annually">
                                                                        <label for="annually"> Annually </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="animalsvaccinated" id="seasonally"
                                                                               value="Seasonally">
                                                                        <label for="seasonally"> Seasonally </label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label class="control-label">How often pest control sprays are
                                                                        carried out?</label>
                                                                    <div class="radio radio-info">
                                                                    ...
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="pestSprayCarriedOut"
                                                                               id="pestsemiannually" value="Semiannually">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Does the insured has veterinary
                                                                        doctor on risk location round the clock?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="insuredVeterinaryDoctor"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Is there any in-house medical
                                                                        emergency team?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="inhouseMedicalEmergency"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="control-label">The animals were ear-tagged, Ring
                                                                        tagged, Micro chipped?</label>
                                                                    <div class="radio radio-info">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Adequate distance is maintained
                                                                        between the animal lanes under the sheds?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="distanceBetweenAnimals"
                                                                               id="distanceBetweenAnimalsYes" value="Yes">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Proper evacuation map for animals
                                                                        is designed to avoid stampede in emergency
                                                                        situation?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="animalsEmergencyEvacuationMap"
                                                                               id="animalsEmergencyEvacuationMapYes" value="Yes">
                                                                        <label for="animalsEmergencyEvacuationMapYes"> Yes </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="animalsEmergencyEvacuationMap"
                                                                               id="animalsEmergencyEvacuationMapNo" value="No">
                                                                        <label for="animalsEmergencyEvacuationMapNo"> No </label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Unauthorized entry is strictly
                                                                        prohibited inside the farm?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="unauthorizedEntryInFarm"
                                                                               id="unauthorizedEntryInFarmYes" value="Yes">
                                                                        <label for="unauthorizedEntryInFarmYes"> Yes </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="unauthorizedEntryInFarm"
                                                                               id="unauthorizedEntryInFarmNo" value="No">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Does the facility is provided with
                                                                        proper waste management system?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="wasteManagementFacility"
                                                                               id="wasteManagementFacilityYes" value="Yes">
                                                                        <label for="wasteManagementFacilityYes"> Yes </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="wasteManagementFacility"
                                                                               id="wasteManagementFacilityNo" value="No">
                                                                        <label for="wasteManagementFacilityNo"> No </label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Animal sheds can resist severe
                                                                        weather?</label>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="severeWeatherResistSheds"
                                                                               id="severeWeatherResistShedsYes" value="Yes">
                                                                        <label for="severeWeatherResistShedsYes"> Yes </label>
                                                                    </div>
                                                                    <div class="radio radio-info">
                                                                        <input type="radio" name="severeWeatherResistSheds"
                                                                               id="severeWeatherResistShedsNo" value="No">
                                                    ...
                                                    <div hidden class="waiverDetailsAbove">
                                                        <div class="form-group">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="control-label"><h4>Choose Surveyor/RMS Team?</h4>
                                                                    </label>
                                                                    <div class="radio-list">
                                                                        <label class="radio-inline p-0">
                                                                            <div class="radio radio-info">
                                                                                <input type="radio" name="nomineeRMS" id="surveyor"
                                                                                       value="Surveyor">
                                                                        ...
                                                                        <label class="radio-inline">
                                                                            <div class="radio radio-info">
                                                                                <input type="radio" name="nomineeRMS" id="rmsteam"
                                                                                       value="RMS Team">
                                                                                <label for="rmsteam">RMS Team</label>
                                                                            </div>
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div id="surveyorPerson">
                                                                <label class="control-label">Surveyor</label>
                                                                <select path="industries" id="surveyorNominee"
                                                                        name="surveyorNominee" class="form-control"
                                                                        data-placeholder="Choose Surveyor Nominee" tabindex="1">
                                                                    <option value="" disabled selected>Choose Surveyor Nominee
                                                                    </option>
                                                                    <c:forEach items="${AllSurveyors}" var="surveyor">
                                                                        <option value="${surveyor.userName}">${surveyor.surveyorCode} ${surveyor.surveyorName}</option>
                                                                    </c:forEach>
                                                                </select>
                                                            </div>

                                                            <div id="rmsPerson">
                                                                <label class="control-label">RMS Team</label>
                                                                <select path="industries" id="teamMemberRMS" name="teamMemberRMS"
                                                                        class="form-control" data-placeholder="Choose RMS Nominee"
                                                                        tabindex="1">
                                                                    <option value="" disabled selected>Choose RMS Nominee</option>
                                                                    <c:forEach items="${AllRMTeam}" var="teamrms">
                                                                        <option value="${teamrms.userName}">${teamrms.name}</option>
                                                                    </c:forEach>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="white-box">
                                                                    ...
                                                                    <div class="alert alert-info"> You have requested for waiver!
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseFour" class="panel-collapse collapse" role="tabpanel"
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <textarea id="findings" name="findings" placeholder="Findings?"
                                                              class="form-control"></textarea>
                                                            </div>
                                                        </div>
                                                        <hr>
                                        ...
                                        <input type="hidden" name="hiddeninputwaiver" style="color: #FFFFFF;" value="" id="twaiver"/>
                                        ...
                                        <input type="hidden" name="hiddeninputnomineeRMS" style="color: #FFFFFF;" value="" id="tnomineeRMS"/>
                                        <input type="hidden" name="hiddeninputsurveyorNominee" style="color: #FFFFFF;" value="" id="tsurveyorNominee"/>
                                        <input type="hidden" name="hiddeninputteamMemberRMS" style="color: #FFFFFF;" value="" id="tteamMemberRMS"/>
...
<!-- /#wrapper -->
<%@ include file="/WEB-INF/views/template/footerBranchUser.jsp" %>
...
<script type="text/javascript">
    ...
    $(function () {
        $('input[name=nomineeRMS]').on('click init-nomineeRMS', function () {
            $('#rmsPerson').toggle($('#rmsteam').prop('checked'));
        }).trigger('init-nomineeRMS');
    })

    $(function () {
        $('input[name=nomineeRMS]').on('click init-nomineeRMS', function () {
            $('#surveyorPerson').toggle($('#surveyor').prop('checked'));
        }).trigger('init-nomineeRMS');
    })
