                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group-vertical row">
                                                <a title="Download" class="btn btn-block btn-success btn-rounded" href="<c:url value="/branchUser/inspectedPic/download/${img.raForm.raFormId}/${img.locInspId}" />"/><i class="mdi mdi-cloud-download"></i>Download</a>
                                                <br>
                                                <a title="Remove" class="btn btn-block btn-danger btn-rounded" href="<c:url value="/branchUser/inspectedPic/delete/${img.raForm.raFormId}/${img.locInspId}" />"/><i class="mdi mdi-delete-empty"></i>Remove</a>
                                            </div>
