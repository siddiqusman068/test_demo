...
public class RCSTeamRAForms {
    ...
    public String rmsTeamRAForm( Model model){
        ...
        return "RMSTeam/RAFormTeam";
    }

    @RequestMapping(value = "/addTeamForm/getRMSTeamRAForm",method = RequestMethod.GET)
    public String getRMSTeamRAForm(
            ...
            @RequestParam("hiddeninputbranch") String hiddeninputbranch,
        ...
        if (hiddeninputwaiver.equals("No waive")) {
            ...
            String mhiddeninputbranch = hiddeninputbranch;

            int id = Integer.parseInt(mhiddeninputbranch);
            Branches branch = branchesService.findById(id);
            raForms.setBranches(branch);
            ...
            raForms.setStatus("Inspection In Progress");
            ...
            rcsLog.setLogAction("RAForm filling Activity by RMS Team for " + branches.getBranchName());
            ...
            return "redirect:/rcsTeam/supportingReport/" + raForms.getRaFormId();
        }
        ...
        if (hiddeninputwaiver.equals("Yes waive")) {
            ...
            return "redirect:/rcsTeam/riskLocations/";
        }
    ...
    public String rmTeamRAForm(@PathVariable ("id") int id,  Model model){
        ...
        return "RMSTeam/RAForm";
    }

    @RequestMapping(value = "/addForm/getRMTeamRAForm",method = RequestMethod.GET)
    public String getRMTeamRAForm(
           /* @RequestParam("hiddeninputriskCost") String hiddeninputriskCost,
            @RequestParam("hiddeninputinsuredName") String hiddeninputinsuredName,
            @RequestParam("hiddeninputvisitDate") String hiddeninputvisitDate,
            @RequestParam("hiddeninputriskLocation") String hiddeninputriskLocation,
        ...
        rcsLog.setRaForm(raForms);
        rcsLog.setRAFormNo(raForms.getRaFormNo());
        rcsLog.setLogAction("RAForm filling Activity by RMS Team");
        rcsLog.setSessionUser(retrieveLoggedinUserName());
        rcsLog.setUserType("RMS Team");
        ...
        return "redirect:/rcsTeam/supportingReport/"+rafId;
    }

    @RequestMapping("/editForm/{id}")
    public String rmTeamRAFormEdit(@PathVariable ("id") int id,  Model model){


        RAForms raForms = raFormsService.findById(id);
        RiskSpecificTextileGarmentSpinning riskSpecificTextileGarmentSpinning = riskSpecificTextileGarmentSpinningService.findById(raForms.getRaFormId());
        RiskSpecificCottonGinning riskSpecificCottonGinning = riskSpecificCottonGinningService.findById(raForms.getRaFormId());
        RiskSpecificOilFeed riskSpecificOilFeed = riskSpecificOilFeedService.findById(raForms.getRaFormId());
        RiskSpecificCosmeticsChemical riskSpecificCosmeticsChemical = riskSpecificCosmeticsChemicalService.findById(raForms.getRaFormId());
        RiskSpecificLiveStocksFarms riskSpecificLiveStocksFarms = riskSpecificLiveStocksFarmsService.findById(raForms.getRaFormId());
        RiskSpecificPaperBoard riskSpecificPaperBoard = riskSpecificPaperBoardService.findByRAForm(raForms.getRaFormId());
        //List<Options> selectedList = getIndustryFromDB(raForms.getRaFormId());
        model.addAttribute("raForms", raForms);
        ...
        return "RMSTeam/editRAForm";
    }

    @RequestMapping(value = "/editForm/getRMTeamRAFormEditPost",method = RequestMethod.GET)
    public String getRMTeamRAFormEditPost(
            @RequestParam("raLocId") String mraLocId,
            @RequestParam("rafId") String rafId,
            @RequestParam("hiddeninputriskCost") String hiddeninputriskCost,
            @RequestParam("hiddeninpuriskCode") String hiddeninpuriskCode,
            @RequestParam("hiddeninputcity") String hiddeninputcity,
            @RequestParam("hiddeninputpolicyNo") String hiddeninputpolicyNo,
        ...
        int raLocId = Integer.parseInt(mraLocId);
        RiskLocations riskLocations = riskLocationService.findById(raLocId);


        int raformid = Integer.parseInt(rafId);
        ...
        raForms.setModified(sqlCurrentDate);
        raForms.setModifiedBy(retrieveLoggedinUserName());
        raFormsService.edit(raForms);
        ...
        if (hiddeninputwaiver.equals("No waive")) {
            ...
            if (mhiddeninputindustries.equals("Specific Information for Textile/Garment Factory/Spinning Mills/Weaving Mills")) {
                RiskSpecificTextileGarmentSpinning riskSpecificTextileGarmentSpinning = riskSpecificTextileGarmentSpinningService.findByRAForm(raformid);
                ...
                riskSpecificTextileGarmentSpinningService.edit(riskSpecificTextileGarmentSpinning);

            } else if (mhiddeninputindustries.equals("Specific Information for Cotton Factory/Cotton Ginning/Pressing Factory")) {
                RiskSpecificCottonGinning riskSpecificCottonGinning = riskSpecificCottonGinningService.findByRAForm(raformid);
                ...
                riskSpecificCottonGinningService.edit(riskSpecificCottonGinning);

            } else if (mhiddeninputindustries.equals("Specific Information for Oil & Feed Mills")) {
                RiskSpecificOilFeed riskSpecificOilFeed = riskSpecificOilFeedService.findByRAForm(raformid);
                ...
                riskSpecificOilFeedService.edit(riskSpecificOilFeed);

            } else if (mhiddeninputindustries.equals("Specific Information for Cosmetics/Chemical Factories/Labs")) {
                RiskSpecificCosmeticsChemical riskSpecificCosmeticsChemical = riskSpecificCosmeticsChemicalService.findByRAForm(raformid);
                ...
                riskSpecificCosmeticsChemicalService.edit(riskSpecificCosmeticsChemical);
            } else if (mhiddeninputindustries.equals("Specific Information for Livestock, Farms")) {
                RiskSpecificLiveStocksFarms riskSpecificLiveStocksFarms = riskSpecificLiveStocksFarmsService.findByRAForm(raformid);
                ...
                riskSpecificLiveStocksFarms.setSevereWeatherResistSheds(mhiddeninputsevereWeatherResistSheds);
                riskSpecificLiveStocksFarms.setRaForm(raForms);
                riskSpecificLiveStocksFarmsService.edit(riskSpecificLiveStocksFarms);

            } else if (mhiddeninputindustries.equals("Specific Information for Paper or Board Mills")) {
                RiskSpecificPaperBoard riskSpecificPaperBoard = riskSpecificPaperBoardService.findByRAForm(raformid);
                ...
                riskSpecificPaperBoardService.edit(riskSpecificPaperBoard);
        ...
        if (hiddeninputwaiver.equals("Yes waive")) {
            ...
            rcsLog.setRaForm(raForms);
            rcsLog.setRAFormNo(raForms.getRaFormNo());
            rcsLog.setLogAction("RAForm editing Activity by "+raForms.getUsers()+" RMS Team for " + branches.getBranchName());
            rcsLog.setSessionUser(retrieveLoggedinUserName());
            rcsLog.setUserType("Branch User");
    ...
    @RequestMapping("/existingRisk/{id}")
    public String rmTeamRAFormExisting(@PathVariable("id") int id, Model model) {


        RAForms raForms = raFormsService.findById(id);
        model.addAttribute("raForms", raForms);

        return "RMSTeam/existingRAForm";
    }

    @RequestMapping(value = "/existingRisk/getRMTeamRAFormExistingPost",method = RequestMethod.GET)
    public String getRMTeamRAFormExistingPost(
            @RequestParam("raLocId") String mraLocId,
            @RequestParam("hiddeninputriskCost") String hiddeninputriskCost,
            @RequestParam("hiddeninpuriskCode") String hiddeninpuriskCode,
            @RequestParam("hiddeninputcity") String hiddeninputcity,
    ...
    @RequestMapping("/reInspectionRisk/{id}")
    public String rmTeamRAFormReInspection(@PathVariable("id") int id, Model model) {


        RAForms raForms = raFormsService.findById(id);
        model.addAttribute("raForms", raForms);

        return "RMSTeam/reInspectionRAForm";
    }

    @RequestMapping(value = "/reInspectionRisk/getRMTeamRAFormReInspectionPost",method = RequestMethod.GET)
    public String getRMTeamRAFormReInspectionPost(
            @RequestParam("rafId") int raformId,
            @RequestParam("raLocId") String mraLocId,
            @RequestParam("hiddeninputriskCost") String hiddeninputriskCost,
            @RequestParam("hiddeninpuriskCode") String hiddeninpuriskCode,
            @RequestParam("hiddeninputcity") String hiddeninputcity,
        ...
        RAForms raForms = new RAForms();
        RAForms oldraForms = raFormsService.findById(raformId);
        Users users = usersService.findUserByName(retrieveLoggedinUserName());
        Users sessionUser = usersService.findUserByName(retrieveLoggedinUserName());
        Branches branches = branchesService.findById(users.getBranches().getBranchId());
        RCSLog rcsLog = new RCSLog();

        raForms.setOldRAFormNo(oldraForms.getRaFormNo());
        raForms.setRaFormNo("000000");
        raForms.setCreated(sqlCurrentDate);
        ...
        if (hiddeninputwaiver.equals("No waive")) {
            ...
            String OldRAFNo = oldraForms.getOldRAFormNo();
            String RAFNo = raForms.getRaFormNo();
            String cuser = users.getName();
            String companyName = raForms.getInsuredName();

            mailMail.sendMailToRI("rcs.ublinusrers@gmail.com", sessionUser.getEmail(), "Risk location re-inspected old RAF NO# " + OldRAFNo, "\n" + "Dear Team,\n\n" + "RAF No# " + RAFNo + " has been initiate by " + cuser + "%20" + companyName +" Company has been surveyed. RFA form is available in the portal for your reference. " + "\n\n\n" + "Please review and revert us accordingly." +"\n\n"+"Best regards,");
        ...
        if (hiddeninputwaiver.equals("Yes waive")) {
            ...
            rcsLog.setRaForm(raForms);
            rcsLog.setRAFormNo(raForms.getRaFormNo());
            rcsLog.setLogAction("Re-Inspection RAForm filling Activity by RMS Team for " + branches.getBranchName());
            rcsLog.setSessionUser(retrieveLoggedinUserName());
            rcsLog.setUserType("Branch User");
    ...
    public String downloadSupportingReports(@PathVariable int id, @PathVariable int docId, HttpServletResponse response) throws IOException {
        ...
        rcsLog.setRaForm(raForms);
        rcsLog.setRAFormNo(raForms.getRaFormNo());
        rcsLog.setLogAction("Report download Activity by RM Team member"+users.getName());
        rcsLog.setSessionUser(retrieveLoggedinUserName());
        rcsLog.setUserType("RMS Team");
        ...
        return "redirect:/rcsTeam/supportingReport/"+id;
    }
    ...
    public String deleteSupportingReports(@PathVariable int id, @PathVariable int docId) {
        ...
        rcsLog.setRaForm(raForms);
        rcsLog.setRAFormNo(raForms.getRaFormNo());
        rcsLog.setLogAction("Report delete Activity by RM Team member "+users.getName());
        rcsLog.setSessionUser(retrieveLoggedinUserName());
        rcsLog.setUserType("RM Team");
    ...
    public String uploadSupportingReports(@Valid FileBucket fileBucket, BindingResult result, Model model, @PathVariable int id, HttpServletRequest request) throws IOException, InvalidFormatException {
        ...
        if (result.hasErrors()) {
            ...
            rcsLog.setRaForm(raForms);
            rcsLog.setRAFormNo(raForms.getRaFormNo());
            rcsLog.setLogAction("Report upload Activity by RM Team member "+users.getName());
            rcsLog.setSessionUser(retrieveLoggedinUserName());
            rcsLog.setUserType("RM Team");
    ...
    public String downloadInspectedPic(@PathVariable int id, @PathVariable int picId, HttpServletResponse response) throws IOException {
        ...
        rcsLog.setRaForm(raForms);
        rcsLog.setRAFormNo(raForms.getRaFormNo());
        rcsLog.setLogAction("Inspection Pic download Activity by RM Team member"+users.getName());
        rcsLog.setSessionUser(retrieveLoggedinUserName());
        rcsLog.setUserType("RM Team");
        ...
        return "redirect:/rcsTeam/inspectedPic/"+id;
    }
    ...
    public String deleteInspectedPic(@PathVariable int id, @PathVariable int picId) {
        ...
        rcsLog.setRaForm(raForms);
        rcsLog.setRAFormNo(raForms.getRaFormNo());
        rcsLog.setLogAction("Inspected pic delete Activity by RM Team member"+users.getName());
        rcsLog.setSessionUser(retrieveLoggedinUserName());
        rcsLog.setUserType("RM Team");
    ...
    public String uploadInspectedPic(@Valid FileBucket fileBucket, BindingResult result, Model model, @PathVariable int id, HttpServletRequest request) throws IOException, InvalidFormatException {
        ...
        if (result.hasErrors()) {
            ...
            rcsLog.setRaForm(raForms);
            rcsLog.setRAFormNo(raForms.getRaFormNo());
            rcsLog.setLogAction("Inspected pic upload Activity by RM Team member"+users.getName());
            rcsLog.setSessionUser(retrieveLoggedinUserName());
            rcsLog.setUserType("RM Team");
    ...
    public String briefSummary(@PathVariable(value = "id") int id,Model model){
        ...
        return "RMSTeam/RMSBriefSummary";
    ...
    public String finalSubmission(@PathVariable int raFormId,Model model){
        ...
        rcsLog.setRaForm(raForms);
        rcsLog.setRAFormNo(raForms.getRaFormNo());
        rcsLog.setLogAction("RAForm final Submission by RM Team" + users.getName());
        rcsLog.setSessionUser(retrieveLoggedinUserName());
        rcsLog.setUserType("RM Team");
    ...
    /*public List<Options> getCityFromDB(int id){

        RiskLocations riskLocations = raFormsService.findById(id);
        RAForms city = raFormsService.findById(riskLocations.getCity());


        String dest = policies.getDestination();
        String[] arrdest = dest.split(",");

        for (int i = 0; i <= arrdest.length-1; i++ ){
            destinations.add(new Options(arrdest[i],arrdest[i]));
        }
    ...
    /*public List<Options> getIndustryFromDB(int id){

        List<Options> industry = new ArrayList<Options>();
        RAForms raForms = raFormsService.findById(id);
        String indust = raForms.getIndustryType();
        String[] arrindust = indust.split(",");

        for (int i = 0; i <= arrindust.length-1; i++ ){
            industry.add(new Options(arrindust[i],arrindust[i]));
        }
    ...
    public @ResponseBody
    String getNtn(@RequestParam String riskCode) {

        List<RiskLocations> locationsList = riskLocationService.findAll();

        for (int i = 0; i < locationsList.size(); i++) {

            if (riskCode.equals(locationsList.get(i).getRiskCode())) {

                RiskLocations riskLocations = riskLocationService.findRiskLocationByRiskCode(riskCode);
                RAForms raForms = raFormsService.findById(riskLocations.getRiskLocationId());

                int id = riskLocations.getRiskLocationId();

                if(riskLocations.getRiskCode().equals("") || riskLocations.getRiskCode().equals(null)){
                    return "<span></span>";
                }else{
                    return "<span><a style='color: red' href='/ublircs/rcsTeam/existingRisk/"+id+"'>Risk already exist created in "+raForms.getCreated()+" RAF No: "+raForms.getRaFormNo()+"</span>";
                }
