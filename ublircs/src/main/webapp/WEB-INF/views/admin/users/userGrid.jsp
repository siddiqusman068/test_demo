        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Users Grid View</h4> </div>
                            ...
                            <table id="myTable" class="table table-striped">
                                ...
                                <c:forEach items="${users}" var="user" varStatus="counter">
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a class="btn waves-effect waves-light right submit indigo darken-3" title="Edit User" href="<spring:url value="users/edit/${user.userId}"/>"> Edit</a>
                                            </div>
                                        </td>
                                    </tr>
                                </c:forEach>
