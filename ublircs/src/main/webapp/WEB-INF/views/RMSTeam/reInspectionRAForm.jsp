                ...
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <form id="validation" class="form-horizontal" method="get"
                              action="<c:url value="/rcsTeam/reInspectionRisk/getRMTeamRAFormReInspectionPost"/>">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="panel-group wiz-aco" id="accordion" role="tablist" aria-multiselectable="true">
                                                ...
                                                <h4 class="panel-title">
                                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne"
                                                       aria-expanded="true" aria-controls="collapseOne">
                                                        <span><i style="font-size: 20px" class="fa fa-bitcoin"></i></span>&nbsp;Risk
                                                        Cost
                                                    </a>
                                                </h4></div>
                                                ...
                                                <h4 class="panel-title">
                                                    <a class="collapsed" data-toggle="collapse" data-parent="#accordion"
                                                       href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                        ...
                                                        Risks
                                                        <div class="below500mDetails" hidden style="display: inline">(Below 500m)
                                                        </div>
                                                        <div class="above500mDetails" hidden style="display: inline;">(Above 500m)
                                                        </div>
                                                    </a>
                                                </h4>
                                            </div>
                                                ...
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" id="riskCode" name="riskCode" class="form-control" readonly value="${raForms.riskLocations.riskCode}" placeholder="Risk Code">
                                                        </div>
                                                        <div class="col-md-4">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" id="policyNo" name="policyNo" class="form-control" placeholder="Policy no.">
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" id="insuredName" name="insuredName" class="form-control" placeholder="Insured name">
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="control-label">Date of Visit</label>
                                                            <input type="text" class="form-control" id="visitDate" name="visitDate" placeholder="dd/mm/yyyy">
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    <div class="row">
                                                    ...
                                                    <div hidden class="waiverDetails">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="electricWiring" id="notApplicables" value="Not Applicable">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="houseKeeping" id="notApplicablee" value="Not Applicable">
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="rawMaterialStored" id="notApplicables" value="Not Applicable">
                                                                    <label for="notApplicables"> N/A </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="electricitySupply" id="notApplicable" value="Not Applicable">
                                                        ...
                                                        <div hidden class="below500mDetails">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <input type="text" class="form-control" id=noOfFireFighters name="noOfFireFighters" placeholder="Number of fire fighters">
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <input type="hidden" name="hiddeninputbranch" style="color: #FFFFFF;" value="" id="tbranch"/>
            ...
            if($("#twaiver").val() == "Yes waive")
            {
                setTimeout(function () {
                    swal({
                            ...
                            function(){
                                window.location.href = "//localhost:8080/ublircs/rcsTeam/home";
                            })
                });
