        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Branches Grid View</h4> </div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <button class="right-side-toggle waves-effect waves-light btn-info btn-circle pull-right m-l-20"><i class="ti-settings text-white"></i></button>
                    <ol class="breadcrumb">
                        <li><a href="#">RCS Team</a></li>
                        <li><a href="#">Branches</a></li>
                        <li class="active">Branches Grid</li>
                    </ol>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="row">
                <div class="text-right">
                    <a href="/ublircs/admin/branches/add" class="fcbtn btn btn-info btn-outline btn-1d m-r-10">Create Branch</a>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-0">Branches Data Table</h3>
                        ...
                        <div class="table-responsive">
                            <table id="myTable" class="table table-striped">
                                <thead>
                                <tr>
                                    <th class="hidden-480 center">Sr</th>
                                ...
                                <c:forEach items="${branches}" var="branchs" varStatus="counter">
                                    ...
                                    <tr>
                                        ...
                                        <td>${branchs.branchCode}</td>
                                        <td class="hidden-480">${branchs.locationCode}</td>
                                        <td class="hidden-480">
                                            <c:if test="${branchs.status == true}">
                                                <a class="btn waves-effect waves-light right green">Active</a>
                                            </c:if>
                                            <c:if test="${branchs.status == false}">
                                                <a class="btn waves-effect waves-light right materialize-red">In-Active</a>
                                            </c:if>
                                        </td>
                                        <td>
                                            <div class="btn-group">
                                                <a href="<spring:url value="/rcsTeam/branches/edit/${branchs.branchId}"/>"
                                                   TITLE="Edit branch" class="btn btn-default btn-circle btn-lg"><i
