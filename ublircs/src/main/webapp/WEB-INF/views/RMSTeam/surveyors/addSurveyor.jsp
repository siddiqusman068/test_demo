        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Surveyors Creation Form</h4> </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <form:form action="${pageContext.request.contextPath}/rcsTeam/surveyors/add" method="post" commandName="surveyors" data-toggle="validator">
                            ...
                            <div class="form-group">
                                ...
                                <form:input type="text" class="form-control" path="mobileContact" name="mobileContact" id="mobileContact" placeholder="Cellular No#" data-error="Enter mobile no." required="required"/>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
                                <c:url value="/rcsTeam/getSurveyorCode" var="getSurveyorCode"/>
                                <label for="surveyorCode" class="control-label">Surveyor Code</label>
                                <form:input type="text" class="form-control" path="surveyorCode" name="surveyorCode" id="surveyorCode" onfocusout="doAjaxCode('${getSurveyorCode}',$(this).val())" placeholder="Surveyor Code" data-error="Enter surveyor code." required="required"/>
...
<script type="text/javascript">
    ...
    function doAjaxCode(lookUrl,code) {
        //alert(cnicNtn);
        $.ajax({
            url: lookUrl,
            data: ({code : code}),
