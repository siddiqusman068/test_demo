        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="text-right">
                    <a href="/ublircs/branchUser/home" class="fcbtn btn btn-info btn-outline btn-1d m-r-10">Back to risk location grid </a>
                </div>
            </div>
            <br>
                                ...
                                <div id="gallery-content">
                                    <div id="gallery-content-center">
                                        <c:forEach items="${locationInspectionPicsList}" var="img" varStatus="counter">
                                            <a href="<c:url value="/branchUser/getImage?id=${img.locInspId}"/>" target="_blank" rel="noopener noreferrer" ><img src="<c:url value="/branchUser/getImage?id=${img.locInspId}"/>" alt="gallery" class="all studio" /> </a>
                                        </c:forEach>
