        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="text-right">
                    <a href="<c:url value="/branchUser/addForm"/>" class="fcbtn btn btn-info btn-outline btn-1d m-r-10">Initiate risk</a>
                </div>
            </div>
            <br>
            <!-- /row -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <c:if test="${ra.status.equals('Assigned For Inspection')}">
                                                <a class="btn btn-block btn-warning btn-rounded">Assigned For Inspection</a>
                                            </c:if>
                                            ...
                                            <c:if test="${ra.status.equals('Request For Waive')}">
                                                <a class="btn btn-block btn-primary btn-rounded">Request For Waive</a>
                                            </c:if>
                                        ...
                                        <td>
                                            <c:if test="${ra.status.equals('Evaluation Complete')}">
                                                <button style="vertical-align: middle" class="btn btn-primary btn-circle btn-lg" title="Summary" onclick="location.href='http://localhost:8080/ublircs/branchUser/briefSummary/${ra.raFormId}'"><i class="fa  fa-files-o"></i></button>
                                            </c:if>
                                        </td>
                                    </tr>
                                </c:forEach>
