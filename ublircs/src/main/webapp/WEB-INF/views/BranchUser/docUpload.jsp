        ...
        <div class="container-fluid">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group-vertical row">
                                                <a title="Download" class="btn btn-block btn-success btn-rounded" href="<c:url value="/branchUser/supportingReport/download/${doc.raForm.raFormId}/${doc.locReportId}" />"/><i class="mdi mdi-cloud-download"></i>Download</a>
                                                <br>
                                                <a title="Remove" class="btn btn-block btn-danger btn-rounded" href="<c:url value="/branchUser/supportingReport/delete/${doc.raForm.raFormId}/${doc.locReportId}" />"/><i class="mdi mdi-delete-empty"></i>Remove</a>
                                            </div>
            ...
            <div class="row">
                <div class="col-sm-12 ol-md-12 col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-lg-2 col-sm-4 col-xs-12 pull-right">
                            <a href="<c:url value="../inspectedPic/${raForms.raFormId}"/>" class="btn btn-block btn-outline btn-rounded btn-info"><i class="mdi mdi-image-album"></i>To Snap Inspection</a>
                        </div>
                    </div>
                </div>
            </div>
